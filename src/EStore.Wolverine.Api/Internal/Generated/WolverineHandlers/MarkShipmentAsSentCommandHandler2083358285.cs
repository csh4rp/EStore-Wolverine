...
{
    // START: MarkShipmentAsSentCommandHandler2083358285
    public class MarkShipmentAsSentCommandHandler2083358285 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public MarkShipmentAsSentCommandHandler2083358285(Microsoft.EntityFrameworkCore.DbContextOptions<EStore.Wolverine.Infrastructure.Database.Contexts.EStoreDbContext> dbContextOptions)
        {
        ...
        {
            var markShipmentAsSentCommandHandler = new EStore.Wolverine.Application.CommandHandlers.Shipments.MarkShipmentAsSentCommandHandler();
            ...
            var markShipmentAsSentCommand = (EStore.Wolverine.Contracts.Commands.Shipments.MarkShipmentAsSentCommand)context.Envelope.Message;
            ...
            await markShipmentAsSentCommandHandler.Handle(markShipmentAsSentCommand, cancellation, shipmentRepository, context).ConfigureAwait(false);
    ...
    // END: MarkShipmentAsSentCommandHandler2083358285
