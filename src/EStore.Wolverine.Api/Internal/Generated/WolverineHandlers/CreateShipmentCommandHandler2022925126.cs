...
{
    // START: CreateShipmentCommandHandler2022925126
    public class CreateShipmentCommandHandler2022925126 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public CreateShipmentCommandHandler2022925126(Microsoft.EntityFrameworkCore.DbContextOptions<EStore.Wolverine.Infrastructure.Database.Contexts.EStoreDbContext> dbContextOptions)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var createShipmentCommand = (EStore.Wolverine.Contracts.Commands.Shipments.CreateShipmentCommand)context.Envelope.Message;
            ...
            var outgoing1 = await EStore.Wolverine.Application.CommandHandlers.Shipments.CreateShipmentCommandHandler.Handle(createShipmentCommand, cancellation, shipmentRepository, context).ConfigureAwait(false);
    ...
    // END: CreateShipmentCommandHandler2022925126
